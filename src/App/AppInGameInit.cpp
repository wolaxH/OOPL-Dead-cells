...
void App::InGameInit() {
    ...
    BGs[4] = std::make_shared<BG>(RESOURCE_DIR"/bg/bg9.png", glm::vec2{8609.0f, -2250.0f}, glm::vec2{1.2f, 1.2f});
    BGs[5] = std::make_shared<BG>(RESOURCE_DIR"/bg/bg7.png", glm::vec2{8609.0f, -970.0f}, glm::vec2{1.2f, 1.2f});
    BGs[6] = std::make_shared<BG>(RESOURCE_DIR"/bg/bg6.png", glm::vec2{6309.5f, -970.0f}, glm::vec2{1.2f, 1.2f});
    BGs[7] = std::make_shared<BG>(RESOURCE_DIR"/bg/bg4.png", glm::vec2{1616.0f, -673.0f}, glm::vec2{0.9f, 0.9f});
